...
class Graph(object):
    '''This class defines the object for storing the graph information.
    Note: adj_list shows each edge twice (except for self-loop). So edge_num is two times of edge number for graph without self-loop.'''
    ...
    def get_neighs(self, idx):
        '''obtain the list of neighbors given a node.'''
